...
with tab2:
    ...
    with kol_s4:
        st.markdown(
            ...
            f'<div style="font-size:0.8rem; color:#4A7FB5; margin-top:-20px;">broj dana za koje su dostupni simultani podaci za obje obveznice*</div>'
            f'<p style="color:#DC3545">{inverzija_mjeseci} dana ({procenat_inverzije:.1f}%)</p></div>',
            unsafe_allow_html=True,
        )
    ...
    with kol_s5:
        st.markdown(
            ...
            f'<div style="font-size:0.8rem; color:#4A7FB5; margin-top:-20px;">broj dana za koje su dostupni simultani podaci za obje obveznice*</div>'
            f'<p style="color:#2E7D32">{pozitivan_mjeseci} dana ({100 - procenat_inverzije:.1f}%)</p></div>',
            unsafe_allow_html=True,
        )
